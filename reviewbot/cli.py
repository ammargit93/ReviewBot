...
from reviewbot.agents.chat import create_session_command, list_sessions_command, chat_command
...
def build_parser():
    ...
    login_parser = subparsers.add_parser("login",help="Create or load a Session in ReviewBot")
    login_parser.add_argument("--name",type=str,help="session name")
    login_parser.set_defaults(func=create_session_command)    
